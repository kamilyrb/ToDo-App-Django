    ...
    return {
        ...
        init: function (options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    'dom': "<'row'<'col-md-4 col-sm-12'ir><'col-md-2 col-sm-12'<'table-group-actions flex-end'B>><'col-md-2 col-sm-12'l><'col-md-4 col-sm-12'p>><'table-scrollable't><'row'<'col-md-6 col-sm-12'i><'col-md-2 col-sm-12'l><'col-md-4 col-sm-12'p>>", // datatable layout
                    ...
                    'ajax': { // define ajax settings
                        ...
                        'data': function (data) { // add request parameters before submit
                            ...
                            $('textarea.form-filter, select.form-filter, input.form-filter:not([type="radio"],[type="checkbox"])', table)
                                .each(function () {
            ...
            $.fn.dataTableExt.oStdClasses.sFilterInput = 'form-control form-control-sm form-filter m-input';
